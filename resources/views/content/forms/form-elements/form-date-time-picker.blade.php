    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-6 mb-1">
          <label class="form-label" for="fp_default">Default</label>
          <input type="text" id="fp_default" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" />
        </div>
        <div class="col-md-6 mb-1">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-1">
          ...
          <input type="text" id="fp-human-friendly" class="form-control flatpickr-human-friendly"
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-12 col-md-6 mb-1 position-relative">
          ...
          <input type="text" id="pd-short-string" class="form-control pickadate-short-string"
      ...
      <div class="row">
        <div class="col-12 col-md-6 mb-1 position-relative">
          ...
          <input type="text" id="pd-months-year" class="form-control pickadate-months-year"
            placeholder="18 June, 2020" />
        </div>
        <div class="col-12 col-md-6 mb-1 position-relative">
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mb-1 position-relative">
          ...
          <input type="text" id="pt-format" class="form-control pickatime-format"
