            ...
            <div class="row g-1">
              ...
              <div class="col-md-4">
                ...
                <input
                  ...
                  data-column-index="5"
                />
                <input type="hidden" id="start_sal" class="form-control dt-date start_sal dt-input" data-column="6" data-column-index="5"
                  name="value_from_start_sal" />
                <input type="hidden" id="end_sal" class="form-control dt-date end_sal dt-input" name="value_from_end_sal" data-column="6"
                  data-column-index="5" />
              </div>
            </div>
          </form>
