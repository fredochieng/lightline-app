                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="https://lightlinepanel.lightlinereasearch.com"
                                                                        style="outline:none" tabindex="-1"
                                                                        target="_blank"><img alt="My Mauzo."
                                                                            src="#"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a href="www.example.com"
                                                                        style="outline:none" tabindex="-1"
                                                                        target="_blank"><img alt="" class="big"
                                                                            ...
                                                                            title="My Mauzo" width="640" /></a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="color:#808389;font-size:15px;">There
                                                                                was a request to change your password!.
                                                                                If you did not make this request then
                                                                                please ignore this email.

                                                                                Otherwise, please click the button below
...
<head>
    <style>
        /* Add some styles to make the email look nice */
        body {
...
<body
    ...
    <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation"
        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; background-color: #ffffff; margin: 20px 0; padding: 0; width: 50%; border-radius: 15px; margin-left:33.3%; padding:10px">
        <tr>
            <td align="center"
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td>
                            <img src="{{asset('logo-1.png')}}" alt="Logo"
                                style="max-width: 205px; margin-left:33.3%"" width=" 150px;">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p>We received a request to reset your password. If you are the one who performed this
                                action then click the button below to reset your password.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 19px; font-weight: bold; text-decoration: none; display: inline-block; margin-left:33.3%"
                                class="button " href="{{ $reset_link }}">Reset Password </a><br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p>If you are not the one who performed this action then please ignore this email.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
